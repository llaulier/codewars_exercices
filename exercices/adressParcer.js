const addressTexts = [
    ...
    `23b chemin des allouettes lieu-dit "Rerandiere" 85170 SAINT-DENIS-LA-CHEVASSE`
  ...
  const parseAddress = addressText => /(?<addressnum>\d+|\d+[b|bis|ter])\s(?<address1>[a-zA-ZÂŒÉÈÊËÇèçéîÎêëàù’'ëâôœ -]{1,33}\s\b)(?<adress2>[a-zA-ZÂŒÉÈÊËÇèçéîÎêëàù’'ëâôœ "1-9-]{1,}\D\b)(?<zip>\d{5})\s(?<city>[a-zA-ZÂŒÉÈÊËŸÿÇûèçôÔÎîéêëàù/’'"ëâôœ -]*)/gm.exec(addressText).groups;
